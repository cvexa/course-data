...
$conn = mysqli_connect('localhost', 'root', '', 'math');
	...
	<div class='alert alert-success col-xs-4 
		col-xs-offset-4 text-center'>";
				echo "Успешно добавихте <b>$user</b> на ниво - 1  с резултат - $final_score в базата данни!";
				echo "<p><a href='read_score.php'>виж резултатите</a></p>";
				echo "</div></div>";
			}else{
